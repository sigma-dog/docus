...
export const Superscript = createBooleanControl({
    ...
    getVariant: (editor) =>
        editor.isActive('superscript') ? 'subtle' : 'ghost',
});
...
export const BulletList = createBooleanControl({
    ...
    getVariant: (editor) =>
        editor.isActive('bulletList') ? 'subtle' : 'ghost',
});
...
export const Blockquote = createBooleanControl({
    ...
    getVariant: (editor) =>
        editor.isActive('blockquote') ? 'subtle' : 'ghost',
});
...
export const TextColor = createSwatchControl({
    ...
    getValue: (editor) => {
        const color = editor.getAttributes('textStyle')?.color as string;
        return color || '';
    },
    getProps: (editor) => ({
...
export const Highlight = createSwatchControl({
    ...
    getValue: (editor) => {
        const color = editor.getAttributes('highlight')?.color as string;
        return color || '';
    },
    getProps: (editor) => ({
...
export const TextStyle = createSelectControl({
    ...
    renderValue: (value, option) => {
        const textStyleMap: Record<string, React.CSSProperties> = {
            paragraph: { fontWeight: 'normal', fontSize: '14px' },
            heading1: { fontWeight: 'bold', fontSize: '18px' },
            heading2: { fontWeight: '600', fontSize: '16px' },
            heading3: { fontWeight: '500', fontSize: '14px' },
            blockquote: { fontStyle: 'italic', fontSize: '14px' },
            horizontalRule: { fontWeight: '500', fontSize: '14px' },
        };
        return (
            <Box style={textStyleMap[value]}>
